...
* started a TEST project: little mailing list application
* development with TDD

Some links to read:
* [JS: going deep with Javascript](https://developer.mozilla.org/en-US/docs/Web/JavaScript/A_re-introduction_to_JavaScript)
