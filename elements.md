...
<section>
	...
	<div class="box alt">
		<div class="row 50% uniform">
			<div class="12u$"><span class="image fit"><img src="{{ site.url }}{{ site.baseurl }}/images/pic07.jpg" alt="" /></span></div>
			<div class="4u  6u(xsmall)"><span class="image fit"><img src="{{ site.url }}{{ site.baseurl }}/images/pic02.jpg" alt="" /></span></div>
			<div class="4u  6u$(xsmall)"><span class="image fit"><img src="{{ site.url }}{{ site.baseurl }}/images/pic03.jpg" alt="" /></span></div>
			<div class="4u$ 6u(xsmall)"><span class="image fit"><img src="{{ site.url }}{{ site.baseurl }}/images/pic04.jpg" alt="" /></span></div>
			<div class="4u  6u$(xsmall)"><span class="image fit"><img src="{{ site.url }}{{ site.baseurl }}/images/pic04.jpg" alt="" /></span></div>
			<div class="4u  6u(xsmall)"><span class="image fit"><img src="{{ site.url }}{{ site.baseurl }}/images/pic02.jpg" alt="" /></span></div>
			<div class="4u$ 6u$(xsmall)"><span class="image fit"><img src="{{ site.url }}{{ site.baseurl }}/images/pic03.jpg" alt="" /></span></div>
			<div class="4u  6u(xsmall)"><span class="image fit"><img src="{{ site.url }}{{ site.baseurl }}/images/pic03.jpg" alt="" /></span></div>
