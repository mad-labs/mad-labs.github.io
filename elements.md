...
<section>
	...
	<div class="box alt">
		<div class="row 50% uniform">
			<div class="12u$"><span class="image fit"><img src="{{ site.url }}{{ site.baseurl }}/{{site.imgs}}/pic07.jpg" alt="" /></span></div>
			<div class="4u  6u(xsmall)"><span class="image fit"><img src="{{ site.url }}{{ site.baseurl }}/{{site.imgs}}/pic02.jpg" alt="" /></span></div>
			<div class="4u  6u$(xsmall)"><span class="image fit"><img src="{{ site.url }}{{ site.baseurl }}/{{site.imgs}}/pic03.jpg" alt="" /></span></div>
			<div class="4u$ 6u(xsmall)"><span class="image fit"><img src="{{ site.url }}{{ site.baseurl }}/{{site.imgs}}/pic04.jpg" alt="" /></span></div>
			<div class="4u  6u$(xsmall)"><span class="image fit"><img src="{{ site.url }}{{ site.baseurl }}/{{site.imgs}}/pic04.jpg" alt="" /></span></div>
			<div class="4u  6u(xsmall)"><span class="image fit"><img src="{{ site.url }}{{ site.baseurl }}/{{site.imgs}}/pic02.jpg" alt="" /></span></div>
			<div class="4u$ 6u$(xsmall)"><span class="image fit"><img src="{{ site.url }}{{ site.baseurl }}/{{site.imgs}}/pic03.jpg" alt="" /></span></div>
			<div class="4u  6u(xsmall)"><span class="image fit"><img src="{{ site.url }}{{ site.baseurl }}/{{site.imgs}}/pic03.jpg" alt="" /></span></div>
